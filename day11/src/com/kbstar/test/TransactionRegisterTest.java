...
public class TransactionRegisterTest {
	...
	public static void main(String[] args) {
		...
		TransactionDTO obj = 
				new TransactionDTO(MakeAccountNumber.makeTrNum(),"20210309100",500,"O","국민카드");			
		TransactionDTO obj2 = 
				new TransactionDTO(MakeAccountNumber.makeTrNum(),"20220309101",600,"O","국민카드");			
		TransactionDTO obj3 = 
				new TransactionDTO(MakeAccountNumber.makeTrNum(),"20230309105",700,"O","국민카드");			
